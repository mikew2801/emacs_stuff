...
(custom-set-variables
 ...
 '(org-agenda-files
   '("/home/michael/Dropbox/3_Emacs/1_Org_Files/2_Todo_Notes.org" "/home/michael/Dropbox/3_Emacs/1_Org_Files/1_Appointments.org" "/home/michael/Dropbox/3_Emacs/1_Org_Files/Gcal.org"))
 ...
 '(package-selected-packages
   '(desktop-environment lsp-mode key-combo key-chord dmenu nix-mode helm-fuzzy-find evil-surround helm-org-rifle treemacs esup citeproc-org all-the-icons-ivy-rich all-the-icons-ivy pkg-info org-re-reveal org-roam-bibtex counsel-web counsel-web-search mentor ob-php arch-packer dired-sidebar neotree pythonic org-gcal expand-region buffer-expose dashboard noxml-fold auto-complete-nxml helm-descbinds alarm-clock guix dired-icon geiser deadgrep vlf markdown-mode ox-pandoc general all-the-icons doom-themes helpful counsel ivy-rich which-key rainbow-delimiters rainbow-delimeters doom-modeline ivy ido-vertical-mode smex bibtex-completion command-log-mode podcaster ob-translate elfeed god-mode resize-window calfw-org google-maps persistent-soft pdf-tools helm-exwm use-package start-menu bluetooth projectile w3m exwm lua-mode slime elpher emms org-babel-eval-in-repl circe wc-mode ztree sorcery-theme sudo-edit spaces spacemacs-theme auctex beacon org-brain org-tree-slide aproject anaconda-mode helm-bibtex bibtex-utils emacsql-mysql edbi wanderlust wiki-summary elpy ein ebib jabber metaweblog xml-rpc org2blog academic-phrases evil))
...
(custom-set-faces
 ...
 '(doom-modeline-bar-inactive ((t (:background "#4f97d7"))))
 '(mode-line ((t (:background "steel blue" :foreground "white"))))
